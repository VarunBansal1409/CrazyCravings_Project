    ...
    <>
      ...
      <div className="nav">
        ...
        <div className="nav-buttons">
          <button className="partner" onClick={() => navigate("/partner")}>
            Partner with us
          </button>
          <button className="login" onClick={() => setShowDrawer(true)}>
            Login
          </button>
          <button className="signin" onClick={() => setShowSignup(true)}>
            Sign in
          </button>
        </div>
      </div>
      ...
      <div className="about-section">
        ...
        <p className="about-text">
          ...
          finish. Whether you're in the mood for a quick snack or a gourmet
          meal, CrazyCravings has got you covered. Join us today and discover
          the joy of effortless food ordering!
        </p>
      </div>
      ...
      <div className="footer">
        ...
        <div className="footer-bottom">
          <LiaCopyrightSolid size={12} /> {new Date().getFullYear()}{" "}
          CrazyCravings. All Rights Reserved.
        </div>
      </div>
    </>
  );
